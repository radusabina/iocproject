...
function AdunarePage() {
  ...
  const navigateToStartPage = () => {
    navigate('/');
     // Assuming your start page route is "/"
  };
  ...
  return (
    ...
    <div className="AdunarePage">
      ...
      <h2>Adunare</h2>
      <p>
        Calculează suma următoarelor două numere și scrie rezultatul.
      </p>
      ...
      <div className="numere-container">
        ...
        <div style={{ fontSize: '16px', fontWeight: 'bold', marginRight: '300px', borderBottom: '10px solid #7e0483', width: '110px', display: 'inline-block'}}>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  	    </div>
        </div>
      ...
      {afiseazaFelicitari && incercari > 0 && (
        ...
        <button onClick={handleGenerareNoiNumere}>Generează Alte Numere</button>
        </div>
)}

      {parseInt(rezultat, 10) !== numar1 + numar2 && incercari > 0 && !afiseazaFelicitari && (
    ...
    <button className="go-to-start-button" onClick={navigateToStartPage}>Back</button>
