...
function CombinatePage() {
    ...
    const genereazaNumereRandom = (operatie) => {
        ...
        const randomNumar2 = Math.floor(Math.random() * 1001);
    ...
    const calculeazaRezultat = () => {
        const rezultatCalculat = operatie === "adunare" ? numar1 + numar2 : numar1Scadere - numar2Scadere;
        setRezultat(rezultatCalculat.toString());
        setRezultatCorect(rezultatCalculat === parseInt(rezultat, 10));
    };
    ...
    return (
        <div className="CombinatePage">
            ...
            <img
                ...
                alt="scooby-picture"
            />
            <h2>Operatii combinate</h2>
            <p>
                Calculează suma sau diferența următoarelor două numere și scrie rezultatul.
            </p>
            <div className="scadere-container" style={{ textAlign: 'left' }}>
                <div className="numar-container">
                    <strong>{operatie === "adunare" ? numar1 : numar1Scadere}</strong>
                    <strong>{operatie === "adunare" ? "+" : "-"}{" "}</strong>
                </div>
                <div className="numar-container">
                    <strong>{operatie === "adunare" ? numar2 : numar2Scadere} </strong>
                </div>
                <div style={{ fontSize: '16px', fontWeight: 'bold', borderBottom: '10px solid #77b92d', width: '100px', display: 'inline-block'}}>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                <div>
                <input
